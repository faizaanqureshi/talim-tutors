  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <p className="text-black text-sm">
          A <Highlight>fourth year</Highlight> student working in project management at Ontario Power Generation. He has a good grasp on <Highlight>physics</Highlight> and <Highlight>chemistry</Highlight>, from kinematics to organic.
        </p>
      </div>
    ),
  },
      ...
      <Accordion type="single" collapsible className="w-full text-stone-300 bg-stone-950 w-3/4 p-4 rounded-3xl mt-5 border-2 border-stone-800">
        <AccordionItem value="item-1" className="border-stone-800">
          ...
          <AccordionContent className="font-base text-lg">
            University Level Calculus I and II: <span className="font-bold text-blue-400">$45/Hour</span><br /> Individual rate (Grades 6-12): <span className="font-bold text-blue-400">$35/Hour</span><br />Referral Rate: <span className="font-bold text-blue-400">$30/Hour</span><br />Group rate (2 people): <span className="font-bold text-blue-400">$25/Hour</span> per person
          </AccordionContent>
        </AccordionItem>
